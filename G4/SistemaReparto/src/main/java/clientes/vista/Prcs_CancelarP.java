...
public class Prcs_CancelarP extends javax.swing.JInternalFrame {

    ProcesosRepetidos procesosr = new ProcesosRepetidos();
    Pedidos pedidos = new Pedidos();
    PedidosDAO pedidosDAO = new PedidosDAO();

    public Prcs_CancelarP() {
        initComponents();
        diseño();
    ...
    public void diseño() {
        ...
        procesosr.cursorMano(Tbl_Datos, Btn_ayuda, Btn_cancelar, Btn_eliminar);
    }

    private void limpiar() {
        procesosr.limpiarTxf(Txt_id);
    }
    ...
    private void cargarDatos(String query) {
        ...
        String encabezado[] = {"ID", "CLIENTE", "DIRE REMITENTE", "DIRE DESTINATARIO", "NOMBRE DESTINATARIO"};
        ...
        int tamaño[] = {25, 25, 100, 100, 100};
        PedidosDAO pedidosDAO = new PedidosDAO();
        List<Pedidos> listadoClientes = pedidosDAO.select();
        for (Pedidos listado : listadoClientes) {
            if (listado.getEstado().equals("0") && listado.getIdCliente().equals(Txt_idC.getText())) {
            datos[0] = listado.getIdPedido();
            datos[1] = listado.getIdCliente();
            datos[2] = listado.getDireR();
            datos[3] = listado.getDireD();
            datos[4] = listado.getNomD();
    ...
    private void initComponents() {
            ...
            .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                ...
                .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                        ...
                        .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                                .addComponent(Txt_idC, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Pnl_ingresoDatosLayout.setVerticalGroup(
            ...
            .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                ...
                .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Btn_fondoEliminar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Lbl_id4.setText("BUSCAR ID PEDIDO O CLIENTE:");
    ...
    private void Tbl_DatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tbl_DatosMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            Txt_idC.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 1).toString());
        }
    ...
    private void Btn_eliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_eliminarMouseClicked
        if (procesosr.isEmptyTxf(Txt_id)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.confirmarEliminación("el Pedido# " + Txt_id.getText())) {
                    pedidos.setIdPedido(Txt_id.getText());
                    pedidosDAO.delete(pedidos);
                    cargarDatos("");
                    procesosr.accionExitosa("Eliminación Exitosa", "Se ha eliminado el pedido #" + Txt_id.getText() + " correctamente");
                    limpiar();
                }
            }
        }
